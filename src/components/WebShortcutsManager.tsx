...
export const WebShortcutsManager: React.FC<WebShortcutsManagerProps> = ({
  ...
  const [formOpenMode, setFormOpenMode] = useState<"new_tab" | "embedded" | "curl_terminal">("new_tab");
  ...
  const handleOpenEditModal = (sc: WebShortcut) => {
    ...
    setFormColor(sc.color || "sky");
    setFormTags((sc.tags || []).join(", "));
    setFormOpenMode(sc.openMode || "new_tab");
    setIsModalOpen(true);
  };
      ...
      {isModalOpen && (
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-sm">
          <div className="bg-slate-900 border border-slate-800 rounded-xl shadow-2xl w-full max-w-lg overflow-hidden font-sans">
            ...
            <form onSubmit={handleSaveShortcut} className="p-5 space-y-4">
              <div>
